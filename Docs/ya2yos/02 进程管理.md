...
![进程管理设计类图](../uml/02_proc_mana/进程管理设计类图.png)
...
![SSD-系统顺序图](../uml/02_proc_mana/SSD-系统顺序图.png)
...
![交互图-clone流程](../uml/02_proc_mana/交互图-clone流程.png)

![活动图-clone创建流程](../uml/02_proc_mana/活动图-clone创建流程.png)
...
![交互图-execve流程](../uml/02_proc_mana/交互图-execve流程.png)

![活动图-execve流程](../uml/02_proc_mana/活动图-execve流程.png)

## 2.5 进程退出：exit 系统调用

总览exit过程进行工作:
![exit_SSD](../uml/02_proc_mana/交互图-exit流程.png)

![活动图-exit流程](../uml/02_proc_mana/活动图-exit流程.png)
...
![交互图-wait4流程](../uml/02_proc_mana/交互图-wait4流程.png)

![活动图-wait4流程](../uml/02_proc_mana/活动图-wait4流程.png)

## 2.7 PID/TID 分配、内核栈与系统信息

### 2.7.1 ID 分配器与 TidHandle（tid.rs / utils/id_allocator.rs）
...
![操作契约](../uml/02_proc_mana/操作契约.png)
