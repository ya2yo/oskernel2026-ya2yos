...
pub fn trap_return() {
    ...
    unsafe {
        ...
        #[cfg(target_arch = "loongarch64")]
        {
            ...
            // kernel registers. Normalize the saved PRMD independently of the
            // current Hart state, then keep interrupts disabled until `ertn`
            // restores userspace with PLV3 and IE enabled.
